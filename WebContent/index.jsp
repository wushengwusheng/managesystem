		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="javascript:;" onClick="member_show('个人信息','','','510')">个人信息</a></li>
						<li><a href="#">切换账户</a></li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="news-list.jsp" data-title="新闻动态" href="javascript:void(0)">新闻动态</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a data-href="comment-list.jsp" data-title="评论列表" href="javascript:;">评论列表</a></li>
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					...
					<li><a data-href="member-dellist.jsp" data-title="删除的会员" href="javascript:;">删除的会员</a></li>
